      ...
      <table cellspacing="0" cellpadding="0" width="600" style="border-collapse:collapse">
        <tr>
          <td style="color:#4d4d4d; font-family:Helvetica, Arial, sans-serif; font-size:32px; line-height:normal; text-align:center; border-collapse:collapse; font-weight:700; padding:35px 0 0" align="center">
            ...
            <?php
              $meeting_label=($is_activity==Meeting::IS_ACTIVITY?Yii::t('frontend','activity'):Yii::t('frontend','meeting'));
              if (!$reopened) {
                  echo Yii::t('frontend','Your {meeting_label} is planned!',['meeting_label'=>$meeting_label]);
              } else {
                  echo Yii::t('frontend','Your {meeting_label} has been modified!',['meeting_label'=>$meeting_label]);
              }
              ?>
          </td>
        </tr>
        <tr>
          <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:center; border-collapse:collapse; padding:10px 60px 0; width:100%" align="center" width="100%">
            <p><em><?= Yii::t('frontend','Hi {owner}, has scheduled a {meeting_label}',['owner'=>$owner,'meeting_label'=>$meeting_label]) ?> <?= $participantList ?> <?= Yii::t('frontend','via') ?> <?= HTML::a(Yii::$app->params['site']['title'],MiscHelpers::buildCommand($meeting_id,Meeting::COMMAND_HOME,0,$user_id,$auth_key,$site_id)); ?>.</em></p>
            <p><?= $intro; ?></p>
            <p><?= HTML::a(Yii::t('frontend','Add this event to your calendar here'),$links['download']); ?> <?= Yii::t('frontend','or by opening the attachment below')?>.</p>
          </td>
        </tr>
        <tr>
          <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:center; border-collapse:collapse; padding:30px 0 30px 0" align="center">
            <div>
<!--[if mso]>
              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?= $links['view']; ?>" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                <w:anchorlock/>
                <center style="color:#ffffff;font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;">Track Order</center>
              </v:roundrect>
            <![endif]--><a href="<?= $links['view']; ?>" style='color:#fff; text-decoration:none; -webkit-text-size-adjust:none; background-color:#ff6f6f; border-radius:5px; display:inline-block; font-family:"Cabin", Helvetica, Arial, sans-serif; font-size:14px; font-weight:regular; line-height:45px; mso-hide:all; text-align:center; width:155px' bgcolor="#ff6f6f" align="center" width="155">View Meeting Plan</a>
</div>
          </td>
        </tr>
        <tr>
          <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:center; border-collapse:collapse; padding:10px 60px 0; width:100%" align="center" width="100%">
            <?= Yii::t('frontend','Alternatively, you can'); ?> <?= HTML::a(Yii::t('frontend','cancel the meeting'),$links['cancel']); ?>.
          </td>
        </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                      <tr>
                        <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:left; border-collapse:collapse" align="left">
                          <span style="color:#4d4d4d; font-size:18px; font-weight:700; line-height:1.3; padding:5px 0"><?= Yii::t('frontend','Activity'); ?></span><br>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate">
                          <tr>
                            <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:left; border-collapse:collapse; background-color:#fff; border:1px solid #e5e5e5; border-radius:5px; padding:12px 15px 15px; vertical-align:top; width:253px" align="left" bgcolor="#ffffff" valign="top" width="253">
                              <span style="color:#4d4d4d; font-size:18px; font-weight:700; line-height:1.3; padding:5px 0"><?= Yii::t('frontend','When')?></span><br>
                              <?= Meeting::friendlyDateFromTimestamp($chosenTime->start); ?>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:center; border-collapse:collapse" align="center">
                        <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate">
                          <tr>
                            <td style="color:#777; font-family:Helvetica, Arial, sans-serif; font-size:14px; line-height:21px; text-align:left; border-collapse:collapse; background-color:#fff; border:1px solid #e5e5e5; border-radius:5px; padding:12px 15px 15px; vertical-align:top; width:253px" align="left" bgcolor="#ffffff" valign="top" width="253">
                              <span style="color:#4d4d4d; font-size:18px; font-weight:700; line-height:1.3; padding:5px 0"><?= Yii::t('frontend','Where')?></span><br />
                              <?php
                              if (!$noPlaces) {
                              ?>
                              <p><?= Html::a($chosenPlace->place->name.' ('.Yii::t('frontend','website').')', $chosenPlace->place->website); ?><br/ >
                                ...
                                <?php if (!empty($place->full_address)) {
                                  ?>
                                  <?= HTML::a(Yii::t('frontend','view map'),
        ...
        <?= \Yii::$app->view->renderFile('@common/mail/section-notes.php',['notes'=>$notes,'links'=>$links]) ?>
      </table>
    </center>
  </td>
</tr>
<?= \Yii::$app->view->renderFile('@common/mail/section-footer-dynamic.php',['links'=>$links]) ?>
